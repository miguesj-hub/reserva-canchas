...
Como máximo tres reservas en estado \textsc{Confirmada}. Si necesitas una
cuarta, cancela primero alguna de las que ya tienes
(\cref{sec:usuario:cancelar}).
...
\subsection*{Como usuario final, intenté ver Reportes o Gestión de Canchas}
