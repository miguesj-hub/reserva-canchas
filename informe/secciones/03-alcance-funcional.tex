...
\begin{xltabular}{\textwidth}{L{6.2cm} C{2.6cm} C{2.6cm}}
  ...
  \\
    ...
    \midrule
    \endfirsthead
    \multicolumn{3}{r}{\small\itshape Continuación de la Tabla \ref{tab:roles}} \\
    \toprule
    \textbf{Funcionalidad} & \textbf{Usuario final} & \textbf{Administrador} \\
    \midrule
    \endhead
...
\begin{xltabular}{\textwidth}{L{3.2cm} L{4.4cm} L{5.4cm}}
  ...
  \\
    ...
    \midrule
    \endfirsthead
    \multicolumn{3}{r}{\small\itshape Continuación de la Tabla \ref{tab:modulos}} \\
    \toprule
    \textbf{Módulo} & \textbf{Pantalla} & \textbf{Descripción} \\
    \midrule
    \endhead
...
Se excluyen las siguientes funcionalidades por decisión explicita:
