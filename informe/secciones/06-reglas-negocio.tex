...
\id{cancha_id} debe compararse por igualdad dentro del índice GiST.
Este requisito se prepara en \path{infra/postgres/init/02-extensiones.sql},
...
\begin{xltabular}{\textwidth}{C{1.6cm} C{2.4cm} L{8.6cm}}
  ...
  \\
    ...
    \midrule
    \endfirsthead
    \multicolumn{3}{r}{\small\itshape Continuación de la Tabla \ref{tab:errores}} \\
    \toprule
    \textbf{Regla} & \textbf{HTTP} & \textbf{Excepción y significado} \\
    \midrule
    \endhead
